...
<form method="GET" action="{{ route('data.pasien') }}">
...
<div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <form id="pasienForm" method="POST" action="{{ route('data-pasien.store') }}">
                    @csrf
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="nama_dokter">Dokter</label>
                        <select name="nama_dokter" id="nama_dokter" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tanggal_kunjungan" id="tanggal_kunjungan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="jenis_kunjungan" id="jenis_kunjungan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                    <div class="mb-4">
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center hover:text-white" data-modal-hide="editPasienModal">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                    </svg>
                    <span class="sr-only">Close modal</span>
            ...
            <form id="pasienForm" method="POST" action="{{ url('/data-pasien/update') }}">
                ...
                <div class='flex flex-row'>
                    <button type="submit" id='submitEdit' class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-4">Simpan</button>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="py-2 px-4 border flex flex-row">
                ...
                data-id="{{ $data->id_pasien }}">Edit</button>
            </td>
        </tr>
        @endforeach
    </tbody>
...
<script>
    ...
    @if (session('successStorePasien'))
        Swal.fire({
            title: 'Sukses!',
            text: '{{ session('successStorePasien') }}',
            icon: 'success',
